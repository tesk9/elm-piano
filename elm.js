...
var _user$project$Flags$Flags = {};
var _user$project$Flags$decoder = _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Flags$Flags);
...
var _user$project$WebAudio$stop = function (stream) {
	return _user$project$Native_WebAudio.stop(stream);
};
var _user$project$WebAudio$play = _user$project$Native_WebAudio.oscillator;

var _user$project$Model$getNonNaturalIndex = F2(
	function (octave, noteInd) {
		var position = A2(_elm_lang$core$Basics_ops['%'], noteInd, 5);
		var leftPositioning = A2(
			F2(
				function (x, y) {
					return x + y;
				}),
			...
			A2(
				...
				_elm_lang$core$Basics$floor(
					(_elm_lang$core$Basics$toFloat(noteInd) * 3) / 5)));
		return A2(
			_elm_lang$core$Maybe$map,
			_elm_lang$core$Basics$toFloat,
			(_elm_lang$core$Native_Utils.eq(position, 1) || _elm_lang$core$Native_Utils.eq(position, 4)) ? _elm_lang$core$Maybe$Just(leftPositioning) : _elm_lang$core$Maybe$Nothing);
	});
var _user$project$Model$toFrequency = function (_p0) {
	var _p1 = _p0;
	return A2(
		F2(
			function (x, y) {
...
var _user$project$Model$toOctave = function (keycode) {
	var _p3 = keycode;
	switch (_p3) {
		case 49:
...
var _user$project$Model$init = function (flags) {
	return {
		currentlyPlaying: _eeue56$elm_all_dict$AllDict$empty(_user$project$Model$toFrequency),
		played: {ctor: '[]'},
		octave: 4,
		time: 0,
		debouncer: _elm_lang$core$Maybe$Nothing
	};
};
var _user$project$Model$Model = F5(
	function (a, b, c, d, e) {
		return {currentlyPlaying: a, played: b, octave: c, time: d, debouncer: e};
	});
var _user$project$Model$GA = {ctor: 'GA'};
var _user$project$Model$G = {ctor: 'G'};
var _user$project$Model$FG = {ctor: 'FG'};
var _user$project$Model$F = {ctor: 'F'};
var _user$project$Model$E = {ctor: 'E'};
var _user$project$Model$DE = {ctor: 'DE'};
var _user$project$Model$D = {ctor: 'D'};
var _user$project$Model$CD = {ctor: 'CD'};
var _user$project$Model$C = {ctor: 'C'};
var _user$project$Model$B = {ctor: 'B'};
var _user$project$Model$AB = {ctor: 'AB'};
var _user$project$Model$A = {ctor: 'A'};
var _user$project$Model$notes = {
	ctor: '::',
	_0: _user$project$Model$A,
	_1: {
		ctor: '::',
		_0: _user$project$Model$AB,
		_1: {
			ctor: '::',
			_0: _user$project$Model$B,
			_1: {
				ctor: '::',
				_0: _user$project$Model$C,
				_1: {
					ctor: '::',
					_0: _user$project$Model$CD,
					_1: {
						ctor: '::',
						_0: _user$project$Model$D,
						_1: {
							ctor: '::',
							_0: _user$project$Model$DE,
							_1: {
								ctor: '::',
								_0: _user$project$Model$E,
								_1: {
									ctor: '::',
									_0: _user$project$Model$F,
									_1: {
										ctor: '::',
										_0: _user$project$Model$FG,
										_1: {
											ctor: '::',
											_0: _user$project$Model$G,
											_1: {
												ctor: '::',
												_0: _user$project$Model$GA,
												_1: {ctor: '[]'}
											}
										}
									}
...
var _user$project$Model$toNote = function (keycode) {
	var _p4 = keycode;
	switch (_p4) {
		case 65:
			return _elm_lang$core$Maybe$Just(_user$project$Model$A);
		case 87:
			return _elm_lang$core$Maybe$Just(_user$project$Model$AB);
		case 83:
			return _elm_lang$core$Maybe$Just(_user$project$Model$B);
		case 68:
			return _elm_lang$core$Maybe$Just(_user$project$Model$C);
		case 82:
			return _elm_lang$core$Maybe$Just(_user$project$Model$CD);
		case 70:
			return _elm_lang$core$Maybe$Just(_user$project$Model$D);
		case 84:
			return _elm_lang$core$Maybe$Just(_user$project$Model$DE);
		case 71:
			return _elm_lang$core$Maybe$Just(_user$project$Model$E);
		case 72:
			return _elm_lang$core$Maybe$Just(_user$project$Model$F);
		case 85:
			return _elm_lang$core$Maybe$Just(_user$project$Model$FG);
		case 74:
			return _elm_lang$core$Maybe$Just(_user$project$Model$G);
		case 73:
			return _elm_lang$core$Maybe$Just(_user$project$Model$GA);
		default:
			return _elm_lang$core$Maybe$Nothing;
	}
};

var _user$project$Update$stop = F2(
	function (noteWithOctave, model) {
		var newCurrentlyPlaying = A2(_eeue56$elm_all_dict$AllDict$remove, noteWithOctave, model.currentlyPlaying);
		var stoppedNote = A2(
			_elm_lang$core$Maybe$map,
			_user$project$WebAudio$stop,
			A2(_eeue56$elm_all_dict$AllDict$get, noteWithOctave, model.currentlyPlaying));
		return _elm_lang$core$Native_Utils.update(
			model,
			{
...
var _user$project$Update$play = F2(
	function (noteWithOctave, model) {
		var newCurrentlyPlaying = (!A2(_eeue56$elm_all_dict$AllDict$member, noteWithOctave, model.currentlyPlaying)) ? A3(
			_elm_lang$core$Basics$flip,
			_eeue56$elm_all_dict$AllDict$insert(noteWithOctave),
			model.currentlyPlaying,
			_user$project$WebAudio$play(
				_user$project$Model$toFrequency(noteWithOctave))) : model.currentlyPlaying;
		return _elm_lang$core$Native_Utils.update(
			model,
			{currentlyPlaying: newCurrentlyPlaying});
	});
var _user$project$Update$perhapsPlay = F2(
	function (keycode, model) {
		return A2(
			...
			A2(
				...
				function (note) {
					return A2(
						_user$project$Update$play,
						{ctor: '_Tuple2', _0: model.octave, _1: note},
						model);
				},
				_user$project$Model$toNote(keycode)));
	});
var _user$project$Update$perhapsChangeOctave = F2(
	function (keycode, model) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			model,
			A2(
				...
				_user$project$Model$toOctave(keycode)));
	});
		...
		switch (_p1.ctor) {
			...
			case 'HandleKeyDown':
				...
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(
						_user$project$Update$perhapsChangeOctave,
						_p2,
						A2(_user$project$Update$perhapsPlay, _p2, model)),
					{ctor: '[]'});
			case 'Play':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Update$play, _p1._0, model),
					{ctor: '[]'});
			case 'Stop':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Update$stop, _p1._0, model),
					{ctor: '[]'});
			case 'Debounce':
				return A2(_user$project$Update$debounce, _p1._0, model);
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Update$debounce = F2(
	function (msg, model) {
		var perhapsUpdate = function (lastTime) {
			return (_elm_lang$core$Native_Utils.cmp(model.time - lastTime, 20) > 0) ? A2(_user$project$Update$update, msg, model) : A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				model,
				{ctor: '[]'});
		};
		return A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_user$project$Update$update, msg, model),
			A2(_elm_lang$core$Maybe$map, perhapsUpdate, model.debouncer));
	});
var _user$project$Update$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$Update$Debounce = function (a) {
	return {ctor: 'Debounce', _0: a};
};
var _user$project$Update$Stop = function (a) {
	return {ctor: 'Stop', _0: a};
};
var _user$project$Update$Play = function (a) {
	return {ctor: 'Play', _0: a};
};
var _user$project$Update$HandleKeyDown = function (a) {
	return {ctor: 'HandleKeyDown', _0: a};
};
var _user$project$Update$NoOp = {ctor: 'NoOp'};
var _user$project$Update$withNote = F2(
...
var _user$project$Styles$namespace_ = 'elm-piano-';
var _user$project$Styles$currentNamespace = _rtfeldman$elm_css_helpers$Html_CssHelpers$withNamespace(_user$project$Styles$namespace_);
var _user$project$Styles$for = function (value) {
	return _elm_lang$html$Html_Attributes$for(
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Styles$namespace_, value));
};
var _user$project$Styles$id = function (value) {
	return _elm_lang$html$Html_Attributes$id(
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Styles$namespace_, value));
};
var _user$project$Styles$_p0 = _user$project$Styles$currentNamespace;
var _user$project$Styles$class = _user$project$Styles$_p0.$class;
var _user$project$Styles$classList = _user$project$Styles$_p0.classList;
var _user$project$Styles$keyEmphasis = function (color) {
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], color.value, ', #4A4A4A) 1 100%'))),
				_1: {
					ctor: '::',
...
var _user$project$Styles$CurrentlyPlaying = {ctor: 'CurrentlyPlaying'};
var _user$project$Styles$NonNatural = {ctor: 'NonNatural'};
var _user$project$Styles$Key = {ctor: 'Key'};
var _user$project$Styles$SelectedOctave = {ctor: 'SelectedOctave'};
var _user$project$Styles$Piano = {ctor: 'Piano'};
var _user$project$Styles$Container = {ctor: 'Container'};
var _user$project$Styles$snippets = {
	ctor: '::',
	_0: A2(
		F2(
			function (x, y) {
	...
	_1: {
				...
				_1: {
					...
					_1: {
						...
						_0: A3(
							...
							_rtfeldman$elm_css$Css$hex('#4A4A4A')),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$width(
								_rtfeldman$elm_css$Css$px(((20 * 7) * 7) + 2)),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		_1: {
			...
			_0: A2(
				...
				_user$project$Styles$SelectedOctave,
				{
					ctor: '::',
					_0: A3(
						...
						_rtfeldman$elm_css$Css$px(1),
						_rtfeldman$elm_css$Css$solid,
						_rtfeldman$elm_css$Css$hex('#0000FF')),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Css$backgroundColor(
											_rtfeldman$elm_css$Css$hex('#fffff0')),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$hover(
												{
													ctor: '::',
													_0: _user$project$Styles$keyEmphasis(
														_rtfeldman$elm_css$Css$hex('#FFDAB9')),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
												_0: A2(
													...
													_user$project$Styles$CurrentlyPlaying,
													{
														ctor: '::',
														_0: _user$project$Styles$keyEmphasis(
															_rtfeldman$elm_css$Css$hex('#fffef0')),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						_user$project$Styles$NonNatural,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$backgroundColor(
											_rtfeldman$elm_css$Css$hex('#2A1E1B')),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$hover(
												{
													ctor: '::',
													_0: _user$project$Styles$keyEmphasis(
														_rtfeldman$elm_css$Css$hex('#400000')),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
...
var _user$project$Styles$css = function (_) {
	return _.css;
}(
	_rtfeldman$elm_css$Css$compile(
		function (x) {
			...
			_rtfeldman$elm_css$Css$stylesheet(
				A2(_rtfeldman$elm_css$Css_Namespace$namespace, _user$project$Styles$currentNamespace.name, _user$project$Styles$snippets)))));

var _user$project$View$viewPlayingNotes = function (currentlyPlaying) {
	return A2(
		...
		A2(
			...
			_eeue56$elm_all_dict$AllDict$keys(currentlyPlaying)));
};
var _user$project$View$viewKey = F3(
	function (currentlyPlaying, noteInd, noteWithOctave) {
		var maybeNonNatural = A2(
			_user$project$Model$getNonNaturalIndex,
			_elm_lang$core$Tuple$first(noteWithOctave),
			noteInd);
		var leftPosition = A2(
			_elm_lang$core$Maybe$withDefault,
			0,
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _user$project$Styles$classList(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _user$project$Styles$Key, _1: true},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: _user$project$Styles$NonNatural,
								_1: !_elm_lang$core$Native_Utils.eq(maybeNonNatural, _elm_lang$core$Maybe$Nothing)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: _user$project$Styles$CurrentlyPlaying,
									_1: A2(_eeue56$elm_all_dict$AllDict$member, noteWithOctave, currentlyPlaying)
								},
								_1: {ctor: '[]'}
							}
						}
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_0: {
								...
								_1: A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Basics$toString(leftPosition),
									'px')
							},
							_1: {ctor: '[]'}
						}),
					_1: {
						...
						_0: _elm_lang$html$Html_Events$onMouseDown(
							_user$project$Update$Play(noteWithOctave)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onMouseLeave(
								_user$project$Update$Stop(noteWithOctave)),
							_1: {
								ctor: '::',
...
var _user$project$View$viewOctave = F3(
	function (currentlyPlaying, selectedOctave, octave) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _user$project$Styles$classList(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: _user$project$Styles$SelectedOctave,
							_1: _elm_lang$core$Native_Utils.eq(selectedOctave, octave)
						},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			...
			A2(
				...
				F2(
					function (index, note) {
						return A3(
							_user$project$View$viewKey,
							currentlyPlaying,
							index,
							{ctor: '_Tuple2', _0: octave, _1: note});
					}),
				_user$project$Model$notes));
	});
var _user$project$View$viewPiano = F2(
	function (currentlyPlaying, selectedOctave) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			A2(
				...
				F2(
					function (index, _p2) {
						return A3(_user$project$View$viewOctave, currentlyPlaying, selectedOctave, index);
					}),
				A2(
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _rtfeldman$elm_css_helpers$Html_CssHelpers$style(_user$project$Styles$css),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Elm Piano'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(_user$project$View$viewPiano, model.currentlyPlaying, model.octave),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Playing the Elm Piano'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Play the piano via point-and-click or via your keyboard.'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Keyboard interaction:'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Currently playing:'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _user$project$View$viewPlayingNotes(model.currentlyPlaying),
											_1: {ctor: '[]'}
										}
									}
								}
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: A2(
				_elm_lang$core$Basics$always,
				A2(_elm_lang$core$Time$every, _elm_lang$core$Time$millisecond, _user$project$Update$Tick),
				model),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(
					function (_p0) {
						return _user$project$Update$Debounce(
							_user$project$Update$HandleKeyDown(_p0));
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$keyboard$Keyboard$ups(
						_user$project$Update$withNote(
							function (note) {
								return _user$project$Update$Stop(
									{ctor: '_Tuple2', _0: model.octave, _1: note});
							})),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$init = function (pageData) {
	var _p1 = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Flags$decoder, pageData);
	if (_p1.ctor === 'Ok') {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			_user$project$Model$init(_p1._0),
			{ctor: '[]'});
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$Main$init, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions, view: _user$project$View$view})(_elm_lang$core$Json_Decode$string);
